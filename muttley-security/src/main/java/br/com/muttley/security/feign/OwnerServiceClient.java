 ...
 */
@FeignClient(value = "${muttley.security.name-server}", path = "/api/v1/owners", configuration = FeignClientConfig.class)
public interface OwnerServiceClient extends RestControllerClient<OwnerImpl> {
