...
public class UserConfig implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(final ApplicationReadyEvent event) {
        try {
            ...
            User user = null;
            try {
                user = this.service.save(new UserPayLoad("Admin", "Usuário para administrar todo o ecossistema", this.defaultUser, null, null, this.passwdDefaultUser, null, true, null, null), "true");
