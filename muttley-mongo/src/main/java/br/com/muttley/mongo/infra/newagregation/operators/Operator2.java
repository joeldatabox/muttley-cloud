...
import br.com.muttley.mongo.infra.newagregation.operators.impl.OperatorCriteriaCONTAINS2;
import br.com.muttley.mongo.infra.newagregation.operators.impl.OperatorCriteriaGT2;
import br.com.muttley.mongo.infra.newagregation.operators.impl.OperatorCriteriaGTE2;
import br.com.muttley.mongo.infra.newagregation.operators.impl.OperatorCriteriaIN2;
import br.com.muttley.mongo.infra.newagregation.operators.impl.OperatorCriteriaIS2;
import br.com.muttley.mongo.infra.newagregation.operators.impl.OperatorCriteriaLIMIT2;
import br.com.muttley.mongo.infra.newagregation.operators.impl.OperatorCriteriaLT2;
import br.com.muttley.mongo.infra.newagregation.operators.impl.OperatorCriteriaLTE2;
import br.com.muttley.mongo.infra.newagregation.operators.impl.OperatorCriteriaOR2;
import br.com.muttley.mongo.infra.newagregation.operators.impl.OperatorCriteriaORDER_BY_ASC2;
import br.com.muttley.mongo.infra.newagregation.operators.impl.OperatorCriteriaORDER_BY_DESC2;
import br.com.muttley.mongo.infra.newagregation.operators.impl.OperatorCriteriaSKIP2;
...
public interface Operator2 {
    ...
    List<AggregationOperation> extractAggregations(final Projection2 projection, final EntityMetaData entityMetaData, final String key, final Object value);

    List<AggregationOperation> extractAggregations(final Projection2 projection, final EntityMetaData entityMetaData, final String compositePropertyWithFather, String key, final Object value);

    List<Criteria> extractCriteria(final Projection2 projection, final EntityMetaData entityMetaData, final String key, final Object value);
