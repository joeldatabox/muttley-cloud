 ...
 */
public class OperatorCriteriaIS2 implements Operator2 {
    private static final String wildcard = ".$is";
    ...
    public List<Criteria> extractCriteria(EntityMetaData entityMetaData, String compositePropertyWithFather, String key, Object value) {
        ...
        return new LinkedList<>(asList(new Criteria(compositePropertyWithFather).is(m != null ? m.converteValue(value) : value)));
    }
}
