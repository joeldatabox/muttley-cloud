 ...
 */
public abstract class AbstractModelResolverEventListener<T extends MultiTenancyModel, D extends ModelResolverEvent<T>> extends AbstractDocumentResolverEventListener<T, D> {
}
