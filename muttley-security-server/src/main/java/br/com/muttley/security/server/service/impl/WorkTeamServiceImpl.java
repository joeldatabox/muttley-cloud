...
public class WorkTeamServiceImpl extends SecurityServiceImpl<WorkTeam> implements WorkTeamService {
    ...
    @Autowired
    public WorkTeamServiceImpl(final WorkTeamRepository repository, final UserRolesViewService userRolesView, final MongoTemplate template, final DocumentNameConfig documentNameConfig) {
