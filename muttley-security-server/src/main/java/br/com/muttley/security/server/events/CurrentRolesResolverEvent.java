 ...
 */
public class CurrentRolesResolverEvent extends ApplicationEvent {
    private final CurrentRolesResolverEventItem source;
    ...
    public CurrentRolesResolverEvent(final CurrentRolesResolverEventItem source) {
        super(source);
        this.source = source;
    }

    @Override
    public CurrentRolesResolverEventItem getSource() {
        return this.source;
    }
